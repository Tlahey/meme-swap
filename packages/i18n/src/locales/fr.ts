export const fr = {
  ...
  settings: {
    ...
    helpStep5: "5. Donnez un nom à votre application (ex: 'Meme Swap') et écrivez une courte description.",
    helpStep6: "6. Cliquez sur 'Create App' pour générer votre clé d'API.",
    helpStep7: "7. Copiez votre clé d'API (une suite de lettres et chiffres) et collez-la dans le champ de gauche.",
    helpDisclaimer: "Note : La clé d'API développeur Giphy est 100% gratuite et propose une limite de requêtes quotidienne largement suffisante pour un usage personnel et développement.",
  ...
  giphySearch: {
    ...
    fetchingError: "Échec du téléchargement du GIF Giphy. Veuillez vérifier votre connexion internet.",
